...
void actFetchTasks(Store<AppState> store) {
  addQueueItem(QueueItemType.Task, QueueItemAction.List, null);
}
...
void actCreateTask(Store<AppState> store, String title) {
  ...
  addQueueItem(QueueItemType.Task, QueueItemAction.Create, uuid);
}
...
void actUpdateTask(Store<AppState> store, String uuid, String title) {
  ...
  addQueueItem(QueueItemType.Task, QueueItemAction.Update, uuid);
}
...
void actDeleteTask(Store<AppState> store, String uuid) {
  ...
  store.dispatch(UpdateTaskAction(task: newTask));
  addQueueItem(QueueItemType.Task, QueueItemAction.Delete, uuid);
}
